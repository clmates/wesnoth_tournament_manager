#!/usr/bin/env node
/**
 * Tournament test - Execute Rounds 1 AND 2, then STOP
 */
...
async function runTest() {
  console.log(`\n${'='.repeat(80)}`);
  console.log(`TOURNAMENT TEST - ROUNDS 1 & 2`);
  console.log(`${'='.repeat(80)}\n`);

  console.log('STEP 1: Run tournament lifecycle (will execute Rounds 1 and 2)\n');
  ...
  await new Promise((resolve) => {
    const child = spawn('node', [
      ...
      env: {
        ...process.env,
        TOURNAMENT_NAME: 'Debug Test - Rounds 1 & 2',
        TOURNAMENT_TYPE: '4',
        TOURNAMENT_MODE: 'A',
        MAX_ROUNDS: '2'
      }
  ...
  console.log(`\n${'='.repeat(80)}`);
  console.log('STEP 2: Database state after Round 2');
  console.log(`${'='.repeat(80)}\n`);

  console.log(`📋 Run this SQL to examine Round 2 state:\n`);
