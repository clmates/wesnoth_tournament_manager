-- Migration: Replace Foreign Key with Conditional Trigger for Team Tournament Support
-- Date: 2026-01-15
...
-- ============================================================================
DROP TRIGGER IF EXISTS trg_validate_round_match_players ON tournament_round_matches;

CREATE TRIGGER trg_validate_round_match_players
...
-- ============================================================================
COMMENT ON TABLE tournament_round_matches IS 'Tournament round matches. In 1v1 mode: player1_id/player2_id are user_ids. In team mode: player1_id/player2_id are team_ids (from tournament_teams table). Validation enforced by conditional trigger.';
COMMENT ON COLUMN tournament_round_matches.player1_id IS 'Player or Team ID: user_id for 1v1 tournaments, team_id for team tournaments. Validated by trg_validate_round_match_players trigger.';
COMMENT ON COLUMN tournament_round_matches.player2_id IS 'Player or Team ID: user_id for 1v1 tournaments, team_id for team tournaments. Validated by trg_validate_round_match_players trigger.';
