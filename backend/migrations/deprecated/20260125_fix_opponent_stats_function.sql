-- Fix recalculate_player_match_statistics function to include elo_gained/elo_lost in map_stats and faction_stats
-- This replaces the previous version that was missing these columns in the SELECT statements
