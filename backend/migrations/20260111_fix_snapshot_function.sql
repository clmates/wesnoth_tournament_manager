-- Fix manage_faction_map_statistics_snapshots function
-- Issue: v_snapshot_after_created was BOOLEAN but GET DIAGNOSTICS assigns INT (ROW_COUNT)
-- Solution: Change variable type to INT
...
SELECT 'Migration: Fixed manage_faction_map_statistics_snapshots function - changed v_snapshot_after_created to INT' AS migration_info;
