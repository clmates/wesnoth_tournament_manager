...
--
-- Name: game_maps; Type: TABLE; Schema: public; Owner: -
--
...
--
-- Name: TABLE tournament_matches; Type: COMMENT; Schema: public; Owner: -
--
--
-- Name: COLUMN tournament_matches.player1_id; Type: COMMENT; Schema: public; Owner: -
--
--
-- Name: COLUMN tournament_matches.player2_id; Type: COMMENT; Schema: public; Owner: -
--
--
-- Name: COLUMN tournament_matches.winner_id; Type: COMMENT; Schema: public; Owner: -
--
--
-- Name: COLUMN tournament_matches.match_id; Type: COMMENT; Schema: public; Owner: -
--
--
-- Name: COLUMN tournament_matches.match_status; Type: COMMENT; Schema: public; Owner: -
--
--
-- Name: COLUMN tournament_matches.played_at; Type: COMMENT; Schema: public; Owner: -
--
--
...
--
-- Name: tournament_round_matches; Type: TABLE; Schema: public; Owner: -
--
...
--
-- Name: COLUMN tournament_rounds.round_classification; Type: COMMENT; Schema: public; Owner: -
--
--
-- Name: COLUMN tournament_rounds.players_remaining; Type: COMMENT; Schema: public; Owner: -
--
--
-- Name: COLUMN tournament_rounds.players_advancing_to_next; Type: COMMENT; Schema: public; Owner: -
--
--
...
--
-- Name: game_maps game_maps_name_key; Type: CONSTRAINT; Schema: public; Owner: -
--
ALTER TABLE ONLY public.game_maps
    ADD CONSTRAINT game_maps_name_key UNIQUE (name);
--
-- Name: game_maps game_maps_pkey; Type: CONSTRAINT; Schema: public; Owner: -
--
ALTER TABLE ONLY public.game_maps
...
--
-- Name: registration_requests registration_requests_nickname_key; Type: CONSTRAINT; Schema: public; Owner: -
--
...
--
-- Name: tournament_round_matches tournament_round_matches_pkey; Type: CONSTRAINT; Schema: public; Owner: -
--
ALTER TABLE ONLY public.tournament_round_matches
    ADD CONSTRAINT tournament_round_matches_pkey PRIMARY KEY (id);
--
-- Name: tournament_round_matches tournament_round_matches_tournament_id_round_id_player1_id__key; Type: CONSTRAINT; Schema: public; Owner: -
--
ALTER TABLE ONLY public.tournament_round_matches
...
--
-- Name: idx_chat_receiver; Type: INDEX; Schema: public; Owner: -
--
...
--
-- Name: idx_matches_admin_reviewed; Type: INDEX; Schema: public; Owner: -
--
...
--
-- Name: idx_matches_created_at_desc; Type: INDEX; Schema: public; Owner: -
--
CREATE INDEX idx_matches_created_at_desc ON public.matches USING btree (created_at DESC);
--
-- Name: idx_matches_loser; Type: INDEX; Schema: public; Owner: -
--
...
--
-- Name: idx_tournament_rounds_tournament; Type: INDEX; Schema: public; Owner: -
--
CREATE INDEX idx_tournament_rounds_tournament ON public.tournament_rounds USING btree (tournament_id);
--
-- Name: idx_tournament_rounds_type; Type: INDEX; Schema: public; Owner: -
--
...
--
-- Name: idx_tournaments_creator; Type: INDEX; Schema: public; Owner: -
--
CREATE INDEX idx_tournaments_creator ON public.tournaments USING btree (creator_id);
--
-- Name: idx_tournaments_formats; Type: INDEX; Schema: public; Owner: -
--
...
--
-- Name: idx_users_elo_rating; Type: INDEX; Schema: public; Owner: -
--
...
--
-- Name: idx_users_is_rated; Type: INDEX; Schema: public; Owner: -
--
CREATE INDEX idx_users_is_rated ON public.users USING btree (is_rated);
--
-- Name: idx_users_matches_played; Type: INDEX; Schema: public; Owner: -
--
...
--
-- Name: idx_users_total_losses; Type: INDEX; Schema: public; Owner: -
--
CREATE INDEX idx_users_total_losses ON public.users USING btree (total_losses);
--
-- Name: idx_users_total_wins; Type: INDEX; Schema: public; Owner: -
--
CREATE INDEX idx_users_total_wins ON public.users USING btree (total_wins DESC);
--
-- Name: idx_users_trend; Type: INDEX; Schema: public; Owner: -
--
...
--
-- Name: tournament_matches fk_tournament_round_match_id; Type: FK CONSTRAINT; Schema: public; Owner: -
--
ALTER TABLE ONLY public.tournament_matches
...
--
-- Name: matches matches_admin_reviewed_by_fkey; Type: FK CONSTRAINT; Schema: public; Owner: -
--
ALTER TABLE ONLY public.matches
    ADD CONSTRAINT matches_admin_reviewed_by_fkey FOREIGN KEY (admin_reviewed_by) REFERENCES public.users(id);
--
-- Name: matches matches_loser_id_fkey; Type: FK CONSTRAINT; Schema: public; Owner: -
--
ALTER TABLE ONLY public.matches
...
--
-- Name: registration_requests registration_requests_reviewed_by_fkey; Type: FK CONSTRAINT; Schema: public; Owner: -
--
ALTER TABLE ONLY public.registration_requests
    ADD CONSTRAINT registration_requests_reviewed_by_fkey FOREIGN KEY (reviewed_by) REFERENCES public.users(id);
--
-- Name: tournament_matches tournament_matches_match_id_fkey; Type: FK CONSTRAINT; Schema: public; Owner: -
--
ALTER TABLE ONLY public.tournament_matches
...
--
-- Name: tournament_matches tournament_matches_round_id_fkey; Type: FK CONSTRAINT; Schema: public; Owner: -
--
ALTER TABLE ONLY public.tournament_matches
...
--
-- Name: tournament_matches tournament_matches_tournament_round_match_id_fkey; Type: FK CONSTRAINT; Schema: public; Owner: -
--
ALTER TABLE ONLY public.tournament_matches
...
--
-- Name: tournament_round_matches tournament_round_matches_player1_id_fkey; Type: FK CONSTRAINT; Schema: public; Owner: -
--
ALTER TABLE ONLY public.tournament_round_matches
...
--
-- Name: tournament_round_matches tournament_round_matches_player2_id_fkey; Type: FK CONSTRAINT; Schema: public; Owner: -
--
ALTER TABLE ONLY public.tournament_round_matches
...
--
-- Name: tournament_round_matches tournament_round_matches_round_id_fkey; Type: FK CONSTRAINT; Schema: public; Owner: -
--
ALTER TABLE ONLY public.tournament_round_matches
...
--
-- Name: tournament_round_matches tournament_round_matches_tournament_id_fkey; Type: FK CONSTRAINT; Schema: public; Owner: -
--
ALTER TABLE ONLY public.tournament_round_matches
...
--
-- Name: tournament_round_matches tournament_round_matches_winner_id_fkey; Type: FK CONSTRAINT; Schema: public; Owner: -
--
ALTER TABLE ONLY public.tournament_round_matches
