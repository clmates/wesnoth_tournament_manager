        ...
        <table className="w-full border-collapse text-sm bg-white">
          <thead>
            <tr className="bg-gradient-to-r from-gray-700 to-gray-800 text-white">
              <th className="px-3 py-4 text-left font-semibold text-xs uppercase tracking-wider border-b-2 border-gray-900 cursor-pointer hover:bg-gray-600 transition-colors" onClick={() => handleSort('opponent_name')}>{t('opponent_name') || 'Opponent'}{getSortIndicator('opponent_name')}</th>
              <th className="px-3 py-4 text-center font-semibold text-xs uppercase tracking-wider border-b-2 border-gray-900 cursor-pointer hover:bg-gray-600 transition-colors" onClick={() => handleSort('total_games')}>{t('games') || 'Games'}{getSortIndicator('total_games')}</th>
              <th className="px-3 py-4 text-center font-semibold text-xs uppercase tracking-wider border-b-2 border-gray-900 cursor-pointer hover:bg-gray-600 transition-colors" onClick={() => handleSort('wins')}>{t('wins') || 'Wins'}{getSortIndicator('wins')}</th>
              <th className="px-3 py-4 text-center font-semibold text-xs uppercase tracking-wider border-b-2 border-gray-900 cursor-pointer hover:bg-gray-600 transition-colors" onClick={() => handleSort('losses')}>{t('losses') || 'Losses'}{getSortIndicator('losses')}</th>
              <th className="px-3 py-4 text-center font-semibold text-xs uppercase tracking-wider border-b-2 border-gray-900 cursor-pointer hover:bg-gray-600 transition-colors" onClick={() => handleSort('winrate')}>{t('winrate') || 'W/R %'}{getSortIndicator('winrate')}</th>
              <th className="px-3 py-4 text-center font-semibold text-xs uppercase tracking-wider border-b-2 border-gray-900 cursor-pointer hover:bg-gray-600 transition-colors" onClick={() => handleSort('current_elo')}>{t('current_elo') || 'Current ELO'}{getSortIndicator('current_elo')}</th>
              <th className="px-3 py-4 text-center font-semibold text-xs uppercase tracking-wider border-b-2 border-gray-900 cursor-pointer hover:bg-gray-600 transition-colors" onClick={() => handleSort('elo_gained')}>ELO Gained{getSortIndicator('elo_gained')}</th>
              <th className="px-3 py-4 text-center font-semibold text-xs uppercase tracking-wider border-b-2 border-gray-900 cursor-pointer hover:bg-gray-600 transition-colors" onClick={() => handleSort('elo_lost')}>ELO Lost{getSortIndicator('elo_lost')}</th>
              <th className="px-3 py-4 text-center font-semibold text-xs uppercase tracking-wider border-b-2 border-gray-900 cursor-pointer hover:bg-gray-600 transition-colors" onClick={() => handleSort('last_elo_against_me')}>Last ELO vs Me{getSortIndicator('last_elo_against_me')}</th>
              <th className="px-3 py-4 text-left font-semibold text-xs uppercase tracking-wider border-b-2 border-gray-900 cursor-pointer hover:bg-gray-600 transition-colors" onClick={() => handleSort('last_match_date')}>{t('last_match') || 'Last Match'}{getSortIndicator('last_match_date')}</th>
            </tr>
          </thead>
          <tbody>
